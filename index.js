...
document.addEventListener('DOMContentLoaded', function() {
  ...
  panoviewer = document.querySelector(".viewer");
  container = document.querySelector(".viewer .container");
  hotspots = Array.prototype.slice.call(document.querySelectorAll(".hotspot"));

  currentPage = "1";
  viewer = new eg.view360.PanoViewer(container, {
      // image: "https://naver.github.io/egjs-view360/v3/examples/panoviewer/etc/img/bookcube1.jpg",
      // image: "https://naver.github.io/egjs-view360/v3/examples/panoviewer/controls/equi-car-inside.jpg",
      // image: "./img/hall.jpeg",
      // image: "https://raw.githubusercontent.com/rajushank84/walkthrough-poc/refs/heads/main/img/hall.jpeg?a=2",
      image: "https://raw.githubusercontent.com/rajushank84/walkthrough-poc/refs/heads/main/img/office3.jpg?a=2",
      // image: "https://raw.githubusercontent.com/rajushank84/walkthrough-poc/refs/heads/main/img/office2.jpeg?a=4",
      useZoom: false,
      // projectionType: eg.view360.PanoViewer.PROJECTION_TYPE.CUBEMAP,
      projectionType: "equirectangular",
      cubemapConfig: {
